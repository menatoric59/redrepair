...
@endverbatim
    <div class="container" id="app_vue">
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="col-md-6">
                {!! Html::image($aviso->imagen,'Imagen del aviso',['class'=>'img-responsive','id'=>'img_preview','width'=>'267']) !!}
                {!! Form::model($aviso,['route'=>['avisos.actualizar',$aviso->id],'method'=>'put','enctype'=>'multipart/form-data','class'=>'form-horizontal']) !!}

...
<title>Cuaderno de Trabajo 1 con portada</title>
...
if(hasRightVersion) {  // if we've detected an acceptable version
	...
	AC_FL_RunContent(
		...
		'width', '1384',
		'height', '1023',
		'src', 'Cuaderno de Trabajo 1 con portada',
		'quality', 'high',
		...
		'wmode', 'window',
		'devicefont', 'false',
		'id', 'Cuaderno de Trabajo 1 con portada',
		'bgcolor', '#999999',
		'name', 'Cuaderno de Trabajo 1 con portada',
		'menu', 'true',
		'allowFullScreen', 'true',
		'allowScriptAccess','sameDomain',
		'movie', 'Cuaderno de Trabajo 1 con portada',
		'salign', ''
		); //end AC code
